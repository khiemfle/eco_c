...
func decryptR5(s int, e int, fr [6]int) {
	log.SetOutput(new(logWriter))

	logFile, err := os.OpenFile("exclude.txt", os.O_RDWR|os.O_CREATE|os.O_APPEND, 0666)
	if err != nil {
		panic(err)
	}
